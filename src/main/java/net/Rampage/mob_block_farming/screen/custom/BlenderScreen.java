...
public class BlenderScreen extends AbstractContainerScreen<BlenderMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MobBlockFarming.MOD_ID,"textures/gui/blender/blender_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MobBlockFarming.MOD_ID,"textures/gui/arrow_progress.png");
