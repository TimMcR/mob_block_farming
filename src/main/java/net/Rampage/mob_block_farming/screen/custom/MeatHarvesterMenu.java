...
public class MeatHarvesterMenu extends AbstractContainerMenu {
    ...
    public MeatHarvesterMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public MeatHarvesterMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MEAT_HARVESTER_MENU.get(), pContainerId);
        this.blockEntity = ((MeatHarvesterBlockEntity) entity);
