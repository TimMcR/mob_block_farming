package net.Rampage.tutorialmod;

import com.mojang.logging.LogUtils;
import net.Rampage.tutorialmod.block.ModBlocks;
import net.Rampage.tutorialmod.block.entity.ModBlockEntities;
import net.Rampage.tutorialmod.block.entity.renderer.PedestalBlockEntityRenderer;
import net.Rampage.tutorialmod.item.ModItems;
import net.Rampage.tutorialmod.screen.ModMenuTypes;
import net.Rampage.tutorialmod.screen.custom.PedestalScreen;
